...
while (granie==1):
  ...
  os.system('cls')
if(pkt1>pkt2):
  print(f" Wygrał gracz pierwszy mając {pkt1} punktów, gracz drugi miał ich zaledwie {pkt2}")  
if(pkt1<pkt2):
  print(f" Wygrał gracz pierwszy mając {pkt2} punktów, gracz drugi miał ich zaledwie {pkt1}") 
if(pkt1==pkt2):
